...
const AdminNews = () => {
  ...
  return (
    <div>
      {!showForm && (
        <button onClick={() => { setCreating(true); setEditing(null); cancel(); }} className="flex items-center gap-2 px-4 py-2 bg-primary text-primary-foreground font-heading font-semibold text-sm uppercase rounded-md hover:bg-primary/90 transition-colors mb-6">
